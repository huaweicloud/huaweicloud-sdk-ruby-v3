...
module DevStar
  class ApplicationServiceApi
    ...
    # @return [File]
    def download_application_code(request = {})
      opts = {}
      query_params = {}
      header_params = {}
      ...
      if request.class.respond_to?(:attribute_map)
        ...
        # query parameters
        if local_var_params.include?(all_keys[:'job_id'])
          query_params["job_id"]=local_var_params[all_keys[:'job_id']]
        end
      ...
      # resource path
      local_var_path = '/v1/application-codes'
