  ...
  class ListTemplatesV2Request
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevStar::ListTemplatesV2Request` initialize method"
      end
      ...
      if attributes.key?('action_id')
        self.actionId = attributes['action_id']
      end
    ...
    def list_invalid_properties
      ...
      if @actionId.nil?
        invalid_properties.push('invalid value for "actionId", actionId cannot be nil.')
      end

      if @actionId.to_s.length > 64
        invalid_properties.push('invalid value for "actionId", the character length must be smaller than or equal to 64.')
      end

      if @actionId.to_s.length < 1
        invalid_properties.push('invalid value for "actionId", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @actionId.nil?
      return false if @actionId.to_s.length > 64
      return false if @actionId.to_s.length < 1
      true
    end
    ...
    # @param [Object] actionId Value to be assigned
    def actionId=(actionId)
      if actionId.nil?
        fail ArgumentError, 'actionId cannot be nil'
      end

      if actionId.to_s.length > 64
        fail ArgumentError, 'invalid value for "actionId", the character length must be smaller than or equal to 64.'
      end

      if actionId.to_s.length < 1
        fail ArgumentError, 'invalid value for "actionId", the character length must be great than or equal to 1.'
      end
