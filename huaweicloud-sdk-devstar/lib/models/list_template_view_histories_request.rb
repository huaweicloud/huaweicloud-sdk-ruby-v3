  ...
  class ListTemplateViewHistoriesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevStar::ListTemplateViewHistoriesRequest` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @platformSource.nil?
        invalid_properties.push('invalid value for "platformSource", platformSource cannot be nil.')
      end

      if @platformSource > 1
        invalid_properties.push('invalid value for "platformSource", must be smaller than or equal to 1.')
      end

      if @platformSource < 0
        invalid_properties.push('invalid value for "platformSource", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @platformSource.nil?
      platformSource_validator = EnumAttributeValidator.new('Integer', [0, 1])
      return false unless platformSource_validator.valid?(@platformSource)
      return false if @platformSource > 1
      return false if @platformSource < 0
      true
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] platformSource Object to be assigned
    def platformSource=(platformSource)
      validator = EnumAttributeValidator.new('Integer', [0, 1])
      unless validator.valid?(platformSource)
        fail ArgumentError, "invalid value for \"platformSource\", must be one of #{validator.allowable_values}."
      end
