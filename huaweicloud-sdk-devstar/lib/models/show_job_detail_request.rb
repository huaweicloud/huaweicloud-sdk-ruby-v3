  ...
  class ShowJobDetailRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevStar::ShowJobDetailRequest` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @jobId.to_s.length > 32
        invalid_properties.push('invalid value for "jobId", the character length must be smaller than or equal to 32.')
      end

      if @jobId.to_s.length < 1
        invalid_properties.push('invalid value for "jobId", the character length must be great than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @jobId.to_s.length > 32
      return false if @jobId.to_s.length < 1
      true
    end
    ...
    def jobId=(jobId)
      ...
      if jobId.to_s.length > 32
        fail ArgumentError, 'invalid value for "jobId", the character length must be smaller than or equal to 32.'
      end

      if jobId.to_s.length < 1
        fail ArgumentError, 'invalid value for "jobId", the character length must be great than or equal to 1.'
      end
