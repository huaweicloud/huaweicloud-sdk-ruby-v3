...
# module DevStar
  class CreateTemplateViewHistoriesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevStar::CreateTemplateViewHistoriesRequest` initialize method"
      end
