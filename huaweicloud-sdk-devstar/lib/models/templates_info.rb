  ...
  class TemplatesInfo
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `DevStar::TemplatesInfo` initialize method"
      end
    ...
    def list_invalid_properties
      ...
      if @templateIds.nil?
        invalid_properties.push('invalid value for "templateIds", templateIds cannot be nil.')
      end
    ...
    def valid?
      return false if @templateIds.nil?
    ...
    def hash
      [templateIds, platformSource].hash
    end
